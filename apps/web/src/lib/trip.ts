    ...
    activities: [
      {
        ...
        location: "Lands 5:25 PM · seats assigned at check-in",
        confirmed: true,
  ...
  },
  {
    ...
    activities: [
      ...
      },
      {
        ...
        location: "Lands PHX 4:55 PM · seats 07E · 07F · 08E",
        confirmed: true,
        confirmedNote: "Booked",
        code: "ATXHVU",
        url: "https://www.southwest.com/air/manage-reservation/",
...
export const GLOBAL_CHECKLIST: ChecklistGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { text: "Southwest check-in — 24 hrs before each flight (conf ATXHVU)" },
